...
using Asp.NetCoreApi.ReflexHelper;
...
namespace Asp.NetCoreApi.Controllers
{
    ...
    public class GeoJsonController : ControllerBase
    {
        ...
        //    var sbqd = _repository.Current<LZModel.GlyjcSbqd>().AsNoTracking().ToList();//设备清单
        //    //ColumnToNote.DtColumnZH()
        //    var swdt = _repository.GetDataTableResult("select a.ID,a.PARAID,a.JCSJ,a.JCZ,a.JSSJ,a.CJSJ,a.YSSJID,b.SBID,b.JCZBMC from glyjc_shuiwei a left join glyjc_jksjjrpzb b on a.PARAID=b.PARAID where a.JCSJ between '2019-06-01 00:00:00' and '2019-07-31 23:59:59'");
        ...
        //    var export = ExportExcel.ExportByte(dtSources, null);
        //    //var jklist = new List<string>() { "331", "330" };//基康
        //    return File(export, "application/octet-stream", "06-07水位(地下地表)" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls");
        //}
