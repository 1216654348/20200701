...
namespace WebApplication1.Model
{
    public partial class GlyjcJcpz
    {
        public GlyjcJcpz()
        {
            ...
            GlyjcRwbCopy20200320 = new HashSet<GlyjcRwbCopy20200320>();
        ...
        public string Jcdxjtbwid { get; set; }
        public string Jcdxjtbwszbid { get; set; }
        public string Sjcjfzrbmid { get; set; }

        public virtual ICollection<GlyjcRwb> GlyjcRwb { get; set; }
        public virtual ICollection<GlyjcRwbCopy20200320> GlyjcRwbCopy20200320 { get; set; }
