...
{
    public partial class VTSycnCnsxjz
    {
        public string MqjzBm { get; set; }
        public string Cnsxid { get; set; }
        public string Id { get; set; }
        public string Cnly { get; set; }
        public DateTime? Jzrq { get; set; }
        public string Cnsxlylx { get; set; }
        public string Mqjz { get; set; }
        public string Dwcqkdbysm { get; set; }
        public int? Jdbfb { get; set; }
        public string Cjrid { get; set; }
        public DateTime? Cjsj { get; set; }
        public string Djrid { get; set; }
        public string Cnwjsj { get; set; }
