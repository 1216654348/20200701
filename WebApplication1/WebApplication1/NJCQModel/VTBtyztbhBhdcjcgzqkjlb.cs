...
{
    public partial class VTBtyztbhBhdcjcgzqkjlb
    {
        public string Id { get; set; }
        public string Bhlx { get; set; }
        public string BhlxBm { get; set; }
        public string BhlxDesc { get; set; }
        ...
        public string Bhlmtlj { get; set; }
        public string Bhlmfbwz { get; set; }
        ...
        public sbyte? Sfzjc { get; set; }
        public string Bz { get; set; }
        public string Bhsytmc { get; set; }
        public byte[] Lj { get; set; }
        public string Bhsyt { get; set; }
        public string Bhlmtid { get; set; }
        public string Bhlmtmc { get; set; }
