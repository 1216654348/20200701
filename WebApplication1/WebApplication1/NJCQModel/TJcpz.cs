...
namespace WebApplication1.NJCQModel
{
    public partial class TJcpz
    {
        ...
        public string Sjcjfzbmid { get; set; }
        public string Sjshfzrid { get; set; }
        public string Sjshfzrbmid { get; set; }
        ...
        public sbyte? Rwsfbhdqzq { get; set; }
        public sbyte? Sfszqxjc { get; set; }
        public int? Zq { get; set; }
        public sbyte? Zqdw { get; set; }
        public string Ds { get; set; }
        public int? Sc { get; set; }
        public string Yjxq { get; set; }
        public string Bz { get; set; }
        public string Sbid { get; set; }
        public sbyte? Pzlx { get; set; }
        public string Bbsx { get; set; }
