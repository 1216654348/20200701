...
{
    public partial class VGlyjcByywhgcjlJcpz
    {
        public string Id { get; set; }
        public string Ycysmc { get; set; }
        public sbyte? Shzt { get; set; }
        public string Jcdxfamc { get; set; }
        public byte[] Lxzd { get; set; }
        public byte[] Jcdxlx { get; set; }
        public DateTime? Byywhrq { get; set; }
        public string Byywhnr { get; set; }
        public string Ssz { get; set; }
        public string Nf { get; set; }
        public string Yf { get; set; }
        public string Rcbyzp { get; set; }
        ...
        public string Sjcjfzrmc { get; set; }
