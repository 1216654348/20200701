...
namespace WebApplication1.LZModel
{
    public partial class GlyjcTf
    {
        ...
        public string Dldd { get; set; }
        public double? Zxfl { get; set; }
        public double? Zxwzjd { get; set; }
        public double? Zxwzwd { get; set; }
        public string Qd { get; set; }
        public int? Qy { get; set; }
        public string Lj { get; set; }
        public string Ydfx { get; set; }
        public int? Ydsd { get; set; }
        public int? Fqbj { get; set; }
        public string Ydfxyc { get; set; }
